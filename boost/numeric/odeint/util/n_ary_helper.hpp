...
#define BOOST_ODEINT_GEN_SCALE_SUM(macro) \
    BOOST_ODEINT_GEN_SCALE_SUM_OUTER((BOOST_ODEINT_GEN_SCALE_SUM_OPERATOR_, macro))
#define BOOST_ODEINT_GEN_SCALE_SUM_OUTER(param) \
    BOOST_PP_REPEAT_FROM_TO(1, BOOST_ODEINT_N_ARY_MAX, BOOST_ODEINT_GEN_SCALE_SUM_, param)
// z, n, (macro, param)
#define BOOST_ODEINT_GEN_SCALE_SUM_(z, n, data) \
...
#define BOOST_ODEINT_GEN_SCALE_SUM_OPERATOR_(n, macro) \
